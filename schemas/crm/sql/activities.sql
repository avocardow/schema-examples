-- activities: Logged interactions (calls, emails, meetings) tied to contacts, companies, deals, or leads.
...
-- Forward FKs: contacts, companies, deals, and leads load after activities alphabetically.
...
CREATE INDEX idx_activities_lead_occurred ON activities (lead_id, occurred_at);
